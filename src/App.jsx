...
function WorkoutTracker() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-blue-100 flex justify-center">
            <div className="w-full max-w-md h-[100dvh] flex flex-col relative bg-white shadow-2xl overflow-hidden">
                ...
                {/* Bottom Navigation */}
                <div className="bg-white border-t border-slate-100 px-6 py-3 flex justify-between items-center z-20 pb-safe flex-shrink-0">
                    <button
